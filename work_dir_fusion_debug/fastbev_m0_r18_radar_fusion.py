...
train_pipeline = [
    ...
    dict(
        type='Collect3D',
        keys=[
            'img', 'radar_points', 'gt_bboxes', 'gt_labels', 'gt_bboxes_3d',
...
data = dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(
                    type='Collect3D',
                    keys=[
                        'img', 'radar_points', 'gt_bboxes', 'gt_labels',
            ...
            box_type_3d='LiDAR',
            ann_file=
            '/home/radardepth/data/nuscenes/nuscenes_infos_train_4d_interval3_max60_wradar.pkl',
            load_interval=1,
            sequential=True,
            n_times=4,
            train_adj_ids=[1, 3, 5],
    ...
    val=dict(
        ...
        box_type_3d='LiDAR',
        ann_file=
        '/home/radardepth/data/nuscenes/nuscenes_infos_val_4d_interval3_max60_wradar.pkl',
        load_interval=1,
        sequential=True,
        n_times=4,
        train_adj_ids=[1, 3, 5],
...
work_dir = 'work_dir_fusion_debug'
gpu_ids = range(0, 1)
